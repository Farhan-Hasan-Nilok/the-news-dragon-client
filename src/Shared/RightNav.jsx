...
import { UserContext } from "../AuthContext/UserAuth.jsx";
const RightNav = () => {
    ...
    return (
        <div className="w-100">
            ...
            <div className="">
                <button onClick={handleGoogleSignIn} type="button" className="btn btn-outline-primary mb-2"> <FaGoogle /> Login with Google</button> <br />
            ...
            <div className="mt-5">
                ...
                <ul className="list-group">
                    <li className="list-group-item"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
